# 04. PROMPT 4: HALAMAN PUBLIK LIVE STREAMING SLOT (`/turnamen/efootball/live`)

Dokumen ini berisi kode tampilan publik mandiri (tanpa login admin dan tanpa sidebar) yang responsif, modern, bertema *High-Voltage Neon Grid*, dan dapat diakses langsung oleh peserta / komunitas melalui link Ngrok (`https://xxxx.ngrok-free.app/turnamen/efootball/live`).

---

## 📋 Instruksi Prompt 4

Buat file view: `resources/views/tour-organizer/efootball/live.blade.php`:
...
### Route Publik: Tambahkan di `routes/web.php`
```php
// Halaman Publik Live Slot Turnamen (Tanpa Login)
