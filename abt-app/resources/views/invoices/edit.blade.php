...
<div x-data="invoiceEditForm()" class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
    ...
    <div class="lg:col-span-7 lg:sticky lg:top-24">
        ...
        <div class="bg-white text-on-surface border border-border-subtle shadow-lg p-6 sm:p-8 flex flex-col justify-between relative rounded-xl box-border overflow-hidden">
            ...
            <div class="absolute top-0 right-8 w-16 h-3.5 bg-primary-container rounded-b-md shadow-sm flex items-center justify-center">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4 pb-4 border-b border-border-subtle">
                    ...
                    <div class="flex justify-end items-start">
                        <template x-if="status === 'paid'">
                            <div class="inline-flex items-center px-3 py-1 rounded-full bg-status-lunas/10 text-status-lunas border border-status-lunas/20">
                        ...
                        <template x-if="status === 'dp_paid'">
                            <div class="inline-flex items-center px-3 py-1 rounded-full bg-status-dp/10 text-status-dp border border-status-dp/20">
                                <span class="w-1.5 h-1.5 rounded-full bg-status-dp mr-1.5 animate-pulse"></span>
                                <span class="text-[10px] font-bold uppercase tracking-wider">DP Terbayar</span>
                            </div>
                        </template>
                        <template x-if="status === 'canceled'">
                            <div class="inline-flex items-center px-3 py-1 rounded-full bg-gray-200 text-gray-700 border border-gray-300">
                                <span class="w-1.5 h-1.5 rounded-full bg-gray-500 mr-1.5"></span>
                                <span class="text-[10px] font-bold uppercase tracking-wider">Dibatalkan</span>
                            </div>
                        </template>
