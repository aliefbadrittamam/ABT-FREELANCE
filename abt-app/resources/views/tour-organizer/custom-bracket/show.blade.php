...
<div class="max-w-7xl mx-auto space-y-6" x-data="{
    ...
    <div class="bg-white dark:bg-[#1e1e1e] rounded-xl border border-border-subtle dark:border-[#2a2a2a] p-4 sm:p-5 shadow-xs"
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-secondary dark:text-gray-400 mt-0.5">
                        Link ini otomatis disertakan di dalam teks broadcast WA saat disalin.
                    </p>
                </div>
            </div>
        ...
        <form action="{{ route('tour-organizer.custom-bracket.updateLiveLink', $tournament) }}" method="POST" class="flex items-center gap-2">
            @csrf
