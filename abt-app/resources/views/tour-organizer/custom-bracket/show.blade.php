...
<div class="max-w-7xl mx-auto space-y-6" x-data="{
    ...
    <!-- Link Live Bagan Streaming Input Bar -->
    <div class="bg-white dark:bg-[#1e1e1e] rounded-xl border border-border-subtle dark:border-[#2a2a2a] p-4 sm:p-5 shadow-xs"
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <h3 class="text-xs font-bold text-on-surface dark:text-white uppercase tracking-wider flex items-center gap-2">
                        Link Live Bagan Monitoring / Streaming
                        @if($tournament->live_link)
                        <span class="text-[9.5px] font-bold bg-emerald-50 text-emerald-600 px-2 py-0.2 rounded-full border border-emerald-200">Custom Event Ini</span>
                        @else
                    ...
                    <p class="text-[11px] text-secondary dark:text-gray-400 mt-0.5">
                        Link ini otomatis disertakan di dalam teks broadcast WA saat disalin. Cukup simpan sekali sebagai default agar seluruh turnamen otomatis menggunakannya.
                    </p>
                </div>
            </div>
        ...
        <form action="{{ route('tour-organizer.custom-bracket.updateLiveLink', $tournament) }}" method="POST" class="space-y-2.5">
            @csrf
            <div class="flex items-center gap-2">
                <div class="relative flex-1">
                    ...
                    <input type="url" name="live_link" x-model="liveUrlInput" placeholder="https://xxxx.ngrok-free.app/turnamen/efootball/live"
            ...
            <!-- Checkbox Simpan sebagai Default untuk Semua Turnamen -->
            <div class="flex items-center gap-2 pt-0.5">
                <label class="inline-flex items-center gap-1.5 cursor-pointer text-xs text-secondary dark:text-gray-300 select-none">
                    ...
                    <span>Jadikan sebagai <strong>Link Default untuk Semua Turnamen</strong> (otomatis dipakai di semua sesi baru tanpa perlu paste lagi)</span>
                </label>
            </div>
        </form>
    </div>
