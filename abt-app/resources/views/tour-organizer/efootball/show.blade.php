...
<div class="max-w-5xl mx-auto space-y-6" x-data="{
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-white dark:bg-[#1e1e1e] p-4 rounded-xl border border-border-subtle dark:border-[#2a2a2a] shadow-xs text-xs">
        ...
        <div>
            <span class="text-[10px] text-secondary dark:text-gray-400 uppercase font-semibold block">Status Slot</span>
    ...
    <!-- Upload Bukti Transfer Hadiah (Jika sudah selesai & ada pemenang) -->
