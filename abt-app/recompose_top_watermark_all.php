...
echo "=== RE-COMPOSING TESTIMONIALS WITH TOP LAYER CENTER WATERMARK & SYNCING ===\n";
...
echo "• Successfully re-composed {$recomposedCount} local testimonial images with Top-Layer Watermark!\n";
...
foreach ($postedTestimonials as $testimonial) {
    ...
    if ($updated) {
        $syncedCount++;
        echo "• #{$testimonial->testimonial_number}: ✅ SYNCED TOP WATERMARK\n";
    }
    usleep(250000);
}

echo "\n=======================================================\n";
echo "SUCCESSFULLY SYNCED {$syncedCount} TOP-WATERMARK POSTINGS TO TELEGRAM!\n";
echo "=======================================================\n";
